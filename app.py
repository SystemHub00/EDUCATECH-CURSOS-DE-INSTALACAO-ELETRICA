...
COURSE_OPTIONS = [
    {
        "id": "1",
        "local": "COSMOS",
        "curso": "INSTALAÇÃO ELÉTRICA RESIDENCIAL PARA INICIANTES",
        "turma": "TURMA INSTALAÇÃO ELÉTRICA 01",
        "dias_aula": "Sábado",
        "horario": "08h até 12h",
        "data_inicio": "11/04/2026",
        "encerramento": "09/05/2026",
        "endereco_curso": "📍Rua Girassol 46 Cosmos, 23056-630",
    },
    {
        "id": "2",
        "local": "COSMOS",
        "curso": "COMANDO ELÉTRICA PARA INICIANTES",
        "turma": "TURMA COMANDO ELÉTRICA 01",
        "dias_aula": "Sábado",
        "horario": "08h até 12h",
        "data_inicio": "11/04/2026",
        "encerramento": "09/05/2026",
                ...
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid">
                        <div class="hero-card">
                            ...
                            <h1 class="hero-title">COMANDO E INSTALAÇÃO ELÉTRICA RESIDENCIAL PARA INICIANTES</h1>
                            <p class="hero-subtitle">
                                Capacitação Profissional com Ênfase em Novas Tecnologias para Ingresso e Permanência no Mercado de Trabalho!<br>
                                📍Local: Rua Girassol 46 Cosmos, 23056-630
                            </p>
                            <div class="hero-highlights">
                                <div class="hero-highlight">
                                    <strong>CONTEÚDO</strong>
                                    INSTALAÇÃO DE TOMADAS<br>
                                    INTERRUPTOR<br>
                                    ILUMINAÇÃO<br>
                                    CAMPAINHA<br>
                                    QUADRO ELÉTRICO<br>
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-grid step-grid--stacked">
                            <div class="form-group">
                                ...
                                <input type="text" id="local" name="local" class="readonly-field" readonly value="{{ form_data.get('local', 'COSMOS') }}">
                            </div>
